 ...
 */
public class PakFakeContext implements Context {
    /**
     * The context id.
     */
     ...
     * The session cookie.
     */
    private SessionCookie session = new PakFakeSessionCookie();

    /**
     * The flash cookie.
     */
    private FlashCookie flash = new PakFakeFlashCookie();
     ...
     * The cookies.
     */
    private PakFakeCookies cookies = new PakFakeCookies();
     ...
     * The fake request.
     */
    private PakFakeRequest request = new PakFakeRequest(this);
    ...
    /**
     * Creates a new instance of {@link PakFakeContext}.
     */
    public PakFakeContext() {
     ...
     */
    public PakFakeContext setCookie(String name, String value) {
     ...
     * @return the current fake request
     */
    public PakFakeContext setCookie(Cookie cookie) {
        cookies.add(cookie);
        return this;
    }
     ...
     */
    public PakFakeContext setPath(String path) {
        this.path = path;
        return this;
    }
     ...
     */
    @Deprecated
    public PakFakeContext setAttribute(String name, String value) {
     ...
     * @return the current Fake Context
     */
    public PakFakeContext setFormField(String name, String value) {
     ...
     * @return the current Fake Context
     */
    public PakFakeContext setFormField(String name, String... values) {
     ...
     * @return the current Fake Context
     */
    public PakFakeContext setParameter(String name, String value) {
     ...
     * @return the current Fake Context
     */
    public PakFakeContext setParameter(String name, List<String> values) {
     ...
     * @return the current Fake Context
     */
    public PakFakeContext setBody(Object body) {
        this.body = body;
        return this;
    }
     ...
     * @return the current fake context
     */
    public PakFakeContext setHeader(String name, String value) {
     ...
     * @return the current fake context
     */
    public PakFakeContext setHeader(String name, String... values) {
     ...
     */
    @Deprecated
    public PakFakeContext setAttribute(String name, File file) {
     ...
     * @return the current fake context
     */
    public PakFakeContext setFormField(String name, File file) {
        files.put(name, new PakFakeFileItem(file, name));
        return this;
    }
     ...
     * @return the current fake context
     */
    public PakFakeContext addToSession(String key, String value) {
     ...
     * @return the current fake context
     */
    public PakFakeContext addToFlash(String key, String value) {
        flash.put(key, value);
        return this;
    }
     ...
     */
    public PakFakeRequest getPakFakeRequest() {
        return request;
    }
}
