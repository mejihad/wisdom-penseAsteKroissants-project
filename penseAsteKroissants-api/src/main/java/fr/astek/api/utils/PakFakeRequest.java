 ...
 */
public class PakFakeRequest  extends Request {
    private final PakFakeContext context;
     ...
     */
    public PakFakeRequest(PakFakeContext fakeContext) {
     ...
     */
    public PakFakeRequest uri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     */
    public PakFakeRequest method(HttpMethod method) {
        this.method = method;
        return this;
    }
}
